...
public final class PermissionFragment extends Fragment implements Runnable {
     ...
     * 准备请求
     */
    public void prepareRequest(FragmentActivity activity, OnPermission call) {
        // 将当前的请求码和对象添加到集合中
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if ((permissions.contains(Permission.REQUEST_INSTALL_PACKAGES) && !PermissionUtil.isHasInstallPermission(getActivity()))
                || (permissions.contains(Permission.SYSTEM_ALERT_WINDOW) && !PermissionUtil.isHasOverlaysPermission(getActivity()))) {
            ...
            if (permissions.contains(Permission.SYSTEM_ALERT_WINDOW) && !PermissionUtil.isHasOverlaysPermission(getActivity())) {
                // 跳转到悬浮窗设置页面
