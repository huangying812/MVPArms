...
import com.plain.permission.OnPermission;
import com.plain.permission.Permission;
import com.plain.permission.XXPermissions;
import com.plain.widget.NumberProgressBar;
...
public final class UpdateDialog {
    ...
    public static final class Builder
        ...
        public void noPermission(List<String> denied, boolean quick) {
            Toast.makeText(getContext(), R.string.dialog_update_permission_hint, Toast.LENGTH_SHORT).show();
        }
    }
